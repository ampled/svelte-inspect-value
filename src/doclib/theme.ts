...
export default {
  colors: {
    ...
    'activityBarBadge.background': inspect['--base08'],
    ...
    'editorBracketHighlight.foreground2': inspect['--base08'],
    'editorBracketHighlight.foreground3': inspect['--base0D'],
    'editorBracketHighlight.foreground4': '#50FA7B',
    'editorBracketHighlight.foreground5': inspect['--base0E'],
    ...
    'editorLink.activeForeground': inspect['--base0D'],
    ...
    'editorOverviewRuler.wordHighlightForeground': inspect['--base0D'],
    'editorOverviewRuler.wordHighlightStrongForeground': '#50FA7B',
    'editorRuler.foreground': '#FFFFFF1A',
    'editorSuggestWidget.background': '#21222C',
    'editorSuggestWidget.foreground': '#F8F8F2',
    'editorSuggestWidget.selectedBackground': '#44475A',
    'editorWarning.foreground': inspect['--base0D'],
    ...
    'gitDecoration.modifiedResourceForeground': inspect['--base0D'],
    ...
    'inputValidation.infoBorder': inspect['--base08'],
    ...
    'list.highlightForeground': inspect['--base0D'],
    ...
    'panel.border': '#BD93F9',
    'panelTitle.activeBorder': inspect['--base08'],
    ...
    'pickerGroup.foreground': inspect['--base0D'],
    'progressBar.background': inspect['--base08'],
    ...
    'terminal.ansiCyan': inspect['--base0D'],
    'terminal.ansiGreen': '#50FA7B',
    'terminal.ansiMagenta': inspect['--base08'],
